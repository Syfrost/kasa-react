...
export default function Footer() {
    return (
        <>
            <footer>
                <svg className="logo_footer" width="211" height="68" viewBox="0 0 211 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id=".LOGO">
                        <path id="Vector"
                        ...
                        <path id="Vector_3"
                              ...
                              fill="#FFFFFF"/>
                        <g id="Group">
                            <path id="Vector_4" d="M92.0322 49.8419V62.4414L97.3731 59.2915V46.6921L92.0322 49.8419Z"
                                  fill="#FFFFFF"/>
                            <path id="Vector_5"
